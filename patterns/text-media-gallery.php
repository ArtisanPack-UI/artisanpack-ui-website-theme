 ...
 * Slug: artisanpack-ui/text-media-gallery
 * Categories: featured, gallery
 * Synced: no
 * Description: Gallery block layout.
 */
?>
...
<!-- wp:artisanpack/gallery {"columns":3,"linkTo":"none"} --><figure class="wp-block-gallery has-nested-images columns-3"></figure><!-- /wp:artisanpack/gallery -->
</section>
