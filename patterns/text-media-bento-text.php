...
/**
 * Title: Text + Media — Bento Text
 * Slug: artisanpack-ui/text-media-bento-text
 * Categories: featured, text
 * Synced: no
 * Description: Bento layout emphasizing text.
 */
?>
