...
/**
 * Title: Features — Side Title
 * Slug: artisanpack-ui/features-side-title
 * Categories: featured, text
 * Synced: no
 * Description: Left-aligned title, feature list on the right.
 */
?>
...
<h2 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-weight:600;letter-spacing:-0.02em;line-height:1.15">Everything you need for a marketing site</h2>
<!-- /wp:artisanpack/heading -->

<!-- wp:artisanpack/paragraph {"textColor":"text-muted","style":{"typography":{"lineHeight":"1.65"}}} -->
<p class="has-text-muted-color has-text-color" style="line-height:1.65">Pair a strong left-aligned title with an at-a-glance feature list on the right.</p>
<!-- /wp:artisanpack/paragraph -->
</div>
<!-- /wp:artisanpack/column -->
