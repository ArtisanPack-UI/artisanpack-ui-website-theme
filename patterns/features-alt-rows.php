...
/**
 * Title: Features — Alt Rows
 * Slug: artisanpack-ui/features-alt-rows
 * Categories: featured, text
 * Synced: no
 * Description: Alternating text/media rows.
 */
?>
...
<p class="has-text-muted-color has-text-color" style="line-height:1.65">Zero-config setup and instant preview.</p>
<!-- /wp:artisanpack/paragraph -->
</div>
...
<!-- wp:artisanpack/paragraph {"textColor":"text-muted","style":{"typography":{"lineHeight":"1.65"}}} -->
<p class="has-text-muted-color has-text-color" style="line-height:1.65">RBAC and security built in.</p>
<!-- /wp:artisanpack/paragraph -->
</div>
<!-- /wp:artisanpack/group -->
</div>
...
<!-- wp:artisanpack/paragraph {"textColor":"text-muted","style":{"typography":{"lineHeight":"1.65"}}} -->
<p class="has-text-muted-color has-text-color" style="line-height:1.65">Every block extends cleanly.</p>
<!-- /wp:artisanpack/paragraph -->
</div>
<!-- /wp:artisanpack/group -->
</div>
