...
/**
 * Title: Blog — Side Heading
 * Slug: artisanpack-ui/blog-side-heading
 * Categories: featured, text
 * Synced: no
 * Description: Left heading, right post grid.
 */
?>
...
<h2 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-weight:600;letter-spacing:-0.02em;line-height:1.15">From the blog</h2>
<!-- /wp:artisanpack/heading -->
