...
/**
 * Title: Blog — List
 * Slug: artisanpack-ui/blog-list
 * Categories: featured, text
 * Synced: no
 * Description: Compact vertical blog list.
 */
?>
...
<!-- wp:artisanpack/query {"queryId":0,"query":{"perPage":6,"inherit":false},"layout":{"type":"constrained"}} --><div class="wp-block-artisanpack-query wp-block-query"><!-- wp:artisanpack/post-template --><!-- wp:artisanpack/post-title {"level":3,"isLink":true} /--><!-- wp:artisanpack/post-date {"textColor":"text-muted"} /--><!-- /wp:artisanpack/post-template --></div><!-- /wp:artisanpack/query -->
</section>
