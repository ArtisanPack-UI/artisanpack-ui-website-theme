 ...
 * Slug: artisanpack-ui/testimonials-spotlight
 * Categories: featured, testimonials
 * Synced: no
 * Description: Single spotlighted testimonial.
 */
?>
...
<p class="has-text-muted-color has-text-color" style="font-family:var(--wp--preset--font-family--mono);font-size:var(--wp--preset--font-size--xsmall);letter-spacing:0.16em;text-transform:uppercase">Testimonials</p>
...
<h2 class="wp-block-heading has-text-align-center" style="font-family:var(--wp--preset--font-family--display);font-weight:600;letter-spacing:-0.02em;line-height:1.15">What builders say</h2>
...
<!-- wp:artisanpack/group {"className":"ap-border-gradient"} --><div class="wp-block-artisanpack-group wp-block-group ap-border-gradient"><!-- wp:artisanpack/quote {"style":{"typography":{"fontStyle":"italic"}}} -->
...
<!-- /wp:artisanpack/quote --></div><!-- /wp:artisanpack/group -->
</section>
