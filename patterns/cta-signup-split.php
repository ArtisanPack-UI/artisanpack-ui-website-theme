...
/**
 * Title: CTA — Sign-up Split
 * Slug: artisanpack-ui/cta-signup-split
 * Categories: featured, cta
 * Synced: no
 * Description: Split newsletter sign-up.
 */
?>
...
<h2 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-weight:600;letter-spacing:-0.02em;line-height:1.15">Get updates</h2>
<!-- /wp:artisanpack/heading -->

<!-- wp:artisanpack/paragraph {"textColor":"text-muted","style":{"typography":{"lineHeight":"1.65"}}} -->
<p class="has-text-muted-color has-text-color" style="line-height:1.65">Short lead.</p>
