...
/**
 * Title: CTA — Sign-up Centered
 * Slug: artisanpack-ui/cta-signup-centered
 * Categories: featured, cta
 * Synced: no
 * Description: Centered newsletter sign-up.
 */
?>
...
<h2 class="wp-block-heading has-text-align-center" style="font-family:var(--wp--preset--font-family--display);font-weight:600;letter-spacing:-0.02em;line-height:1.15">Get updates</h2>
